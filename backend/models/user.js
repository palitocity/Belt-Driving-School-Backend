...
const userSchema = new mongoose.Schema({
  ...
  studentDetails: {
    ...
    currentPlan: { type: mongoose.Schema.Types.ObjectId, ref: 'Plan', default: null }, // Reference to Plan model
    planAmount: { type: Number, default: 0 },
    planActive: { type: Boolean, default: false },
    planCurrency: { type: String, default: 'NGN' },
    durationMonths: { type: Number, default: 0 },
    planExpiry: Date,
    assignedInstructor: { type: mongoose.Schema.Types.ObjectId, ref: 'User' ,default: null }, // Reference to Instructor
  ...
  instructorDetails: {
    ...
    assignedStudents: [{ type: mongoose.Schema.Types.ObjectId, ref: 'User', default: null }], // References to Student users
  },
  transactions: [
    {
